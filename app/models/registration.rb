...
class Registration < ActiveRecord::Base
  attr_accessible :Email, :Klassierung, :Klassierungswert, :Name, :TelefonNummer, :Vorname, :draw_men_doubles, :draw_men_singles, :draw_men_seniors, :draw_team_cup, :partner_men_doubles, :partner_team_cup, :tournament_id, :comment, :participate_event
