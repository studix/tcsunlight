...
class EventRegistrationsControllerTest < ActionController::TestCase
  ...
  test "should create event_registration" do
    assert_difference('EventRegistration.count') do
      post :create, event_registration: { Email: @event_registration.Email, Name: @event_registration.Name, Vorname: @event_registration.Vorname, event_name: @event_registration.event_name }
    end
  ...
  test "should update event_registration" do
    put :update, id: @event_registration, event_registration: { Email: @event_registration.Email, Name: @event_registration.Name, Vorname: @event_registration.Vorname, event_name: @event_registration.event_name }
    assert_redirected_to event_registration_path(assigns(:event_registration))
  end
